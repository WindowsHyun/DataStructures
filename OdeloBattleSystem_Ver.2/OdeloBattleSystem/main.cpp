...
int main()
{
	...
	OdeloGame.SetYourFunc( 
		...
		//	/*흑돌Attack*/ BlackAttack_2012180027, /*흑돌Defence*/BlackDefence, 
		//  /*백돌Attack*/ WhiteAttack_2012181017, /*백돌Defence*/WhiteDefence_2012181017 );
