...
void BlackAttack_2012180004( int *x, int *y ){
	...
	// //가장 놓으면 안되는 자리
	//if( isBlackAIx_2012180004[1] != 0 && isBlackAIy_2012180004[1] != 0 && isBlackAiCount_2012180004[1] != 0){
	//	if( isBlackAIx_2012180004[0] == 1 && isBlackAIy_2012180004[0] == 1 && isBlackAiCount_2012180004[0] != 0){
	//		isBlackAIx_2012180004[0] = isBlackAIx_2012180004[1], isBlackAIy_2012180004[0] = isBlackAIy_2012180004[1];
	//	}else if( isBlackAIx_2012180004[0] == 6 && isBlackAIy_2012180004[0] == 1 && isBlackAiCount_2012180004[0] != 0){
	//		isBlackAIx_2012180004[0] = isBlackAIx_2012180004[1], isBlackAIy_2012180004[0] = isBlackAIy_2012180004[1];
	//	}else if( isBlackAIx_2012180004[0] == 1 && isBlackAIy_2012180004[0] == 6 && isBlackAiCount_2012180004[0] != 0){
	//		isBlackAIx_2012180004[0] = isBlackAIx_2012180004[1], isBlackAIy_2012180004[0] = isBlackAIy_2012180004[1];
	//	}else if( isBlackAIx_2012180004[0] == 6 && isBlackAIy_2012180004[0] == 6 && isBlackAiCount_2012180004[0] != 0){
	//		isBlackAIx_2012180004[0] = isBlackAIx_2012180004[1], isBlackAIy_2012180004[0] = isBlackAIy_2012180004[1];
	//	}
	//}
